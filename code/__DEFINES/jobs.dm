...
//Defines Factions
#define FACTION_NOBLES	  "Castle"
#define FACTION_COMMONER  "Commoner"
...
#define JOB_DISPLAY_ORDER_PEASANT 34
#define JOB_DISPLAY_ORDER_CASTELLAN 35