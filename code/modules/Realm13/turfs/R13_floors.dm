...
/turf/open/floor/plating/realm// don't use this for anything, /f13/ is essentially just the new /unsimulated/ but for planets and should probably be phased out entirely everywhere
	gender = PLURAL
	baseturfs = /turf/open/floor/plating/f13
	attachment_holes = FALSE
	planetary_atmos = TRUE

/turf/open/floor/plating/realm/inside
	planetary_atmos = FALSE

/* so we can't break this */
/turf/open/floor/plating/realm/try_replace_tile(obj/item/stack/tile/T, mob/user, params)
	return

/turf/open/floor/plating/realm/burn_tile()
	return

/turf/open/floor/plating/realm/MakeSlippery(wet_setting, min_wet_time, wet_time_to_add, max_wet_time, permanent)
	return

/turf/open/floor/plating/realm/MakeDry()
	return

/turf/open/floor/plating/realm/outside
...
/turf/open/floor/plating/realm/outside/Initialize()
	. = ..()
...
/turf/open/floor/plating/realm/inside/slabfull
	name = "Stone Slab"
	desc = "A floor made of stone slab"
	icon = 'icons/Realm13/turf/open/floors.dmi'
	icon_state = "slabfull"

/turf/open/floor/plating/realm/inside/stonebrickfloor
	name = "Stone Brick Floor"
	desc = "A floor made of stone bricks"
	icon = 'icons/Realm13/turf/open/floors.dmi'
	icon_state = "stonebrickfloor"

/turf/open/floor/plating/realm/inside/stonebrickfloor/border
	icon_state = "sbrickborders"

/turf/open/floor/plating/realm/inside/stonebrickfloor/corners
	icon_state = "sbrickcorners"

/turf/open/floor/plating/realm/inside/largestonebrickfloor
	name = "Stone Brick Floor"
	desc = "A floor made of stone bricks"
	icon = 'icons/Realm13/turf/open/floors.dmi'
	icon_state = "lsbrickfloor"

/turf/open/floor/plating/realm/inside/largestonebrickfloor/border
	icon_state = "lsbrickborders"

/turf/open/floor/plating/realm/inside/largestonebrickfloor/corners
	icon_state = "lsbrickcorners"
